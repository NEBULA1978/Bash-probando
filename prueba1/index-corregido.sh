...
customize_settings() {
  for option in "${!OPTIONS[@]}"; do
    default_value=${DEFAULT_VALUES[option]}
    user_input=${default_value}
    case $option in
      0) GRID_DISPLAY=$user_input ;;
      1) FLEX_DIRECTION=$user_input ;;
      2) FLEX_WRAP=$user_input ;;
      3) JUSTIFY_CONTENT=$user_input ;;
      4) ALIGN_ITEMS=$user_input ;;
      5) ALIGN_CONTENT=$user_input ;;
      6) ITEM_WIDTH=$user_input ;;
      7) ITEM_HEIGHT=$user_input ;;
      8) ITEM_MARGIN=$user_input ;;
      9) ITEM_BG_COLOR=$user_input ;;
      10) CENTERED_BOX_WIDTH=$user_input ;;
      11) CENTERED_BOX_HEIGHT=$user_input ;;
      12) CENTERED_BOX_BG_COLOR=$user_input ;;
      ...
      19) CENTERED_CONTENT=$user_input ;;
    esac
  done
}
